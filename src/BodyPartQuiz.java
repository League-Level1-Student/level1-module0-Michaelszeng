	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (guess.equals("arnold") && i == 0) {
				score = score + 1;
				showNextImage();
				System.out.println("Yer right yer score is " + score);
			...
			// -- Tell them they are wrong and who the person is
				...
				if (i == 0) {
					System.out.println("Yer wrung. the currect answore is arnold");
				}
				if (i == 1) {
					System.out.println("Yer wrung. the currect answore is leonardo");
				}
				if (i == 2) {
					System.out.println("Yer wrung. the currect answore is morgan");
				}
				if (i == 3) {
					System.out.println("Yer wrung. the currect answore is Jack");
				}
			}
		}
		...
		System.out.println("yer finl scure is" + score);
