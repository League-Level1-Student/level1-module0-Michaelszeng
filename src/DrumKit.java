...
/*
drum *    Copyright (c) The League of Amazing Programmers 2013-2017
 *    Level 1
 */
...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
		...
		String drum = "drum_but_real_this_time.jpg";
		...
		// each one.
		String goldenthing = "GoldenThing.jpg";
		goldenThing = createLabelImage(goldenthing);
		panel.add(goldenThing);
		frame.pack();
		goldenThing.addMouseListener(this);

		String bassdrum = "BassDrum.jpg";
		bassDrum = createLabelImage(bassdrum);
		panel.add(bassDrum);
		frame.pack();
		bassDrum.addMouseListener(this);
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (drumClicked == bassDrum) {
			playSound("bassDrum3.wav");
		}
		if (drumClicked == goldenThing) {
